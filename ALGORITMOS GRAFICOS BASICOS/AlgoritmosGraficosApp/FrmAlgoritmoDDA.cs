...
namespace AlgoritmosGraficosApp
{
    ...
    {
        private CAlgoritmoDDA dda;
        private int indiceActual;
        private Timer timer;
        private static FrmAlgoritmoDDA instancia;
        ...
        public static FrmAlgoritmoDDA ObtenerInstancia()
        {
            if (instancia == null || instancia.IsDisposed)
            {
                instancia = new FrmAlgoritmoDDA();
            }
            return instancia;
        }
        private void btnCalcular_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dda = new CAlgoritmoDDA(x0, y0, x1, y1, altura, escala);
                indiceActual = 0;
                timer.Start();
            }
            catch (Exception ex)
        ...
        private void FrmAlgoritmoDDA_Load(object sender, EventArgs e)
        {
